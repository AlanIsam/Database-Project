...
<form method="post">
    <div class="mb-3">
        ...
        <select class="form-control" id="member_id" name="member_id" required>
            ...
            <option value="<?php echo $m['member_id']; ?>" <?php echo ($m['member_id'] == $data['member_id']) ? 'selected' : ''; ?>><?php echo $m['member_name']; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
    <div class="mb-3">
        ...
        <select class="form-control" id="employee_id" name="employee_id" required>
            ...
            <option value="<?php echo $c['employee_id']; ?>" <?php echo ($c['employee_id'] == $data['employee_id']) ? 'selected' : ''; ?>><?php echo $c['employee_name']; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
    <div class="mb-3">
        <label for="payment_amount" class="form-label">Amount</label>
        <input type="number" step="0.01" class="form-control" id="payment_amount" name="payment_amount" value="<?php echo $data['payment_amount']; ?>" required>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <select class="form-control" id="payment_method" name="payment_method" required>
            ...
            <option value="Card" <?php echo ($data['payment_method'] == 'Card') ? 'selected' : ''; ?>>Card</option>
