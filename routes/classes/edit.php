...
<form method="post">
    <div class="mb-3">
        ...
        <select class="form-control" id="program_id" name="program_id" required>
            ...
            <option value="<?php echo $p['program_id']; ?>" <?php echo ($p['program_id'] == $data['program_id']) ? 'selected' : ''; ?>><?php echo $p['name']; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
    <div class="mb-3">
        ...
        <select class="form-control" id="trainer_id" name="trainer_id" required>
            ...
            <option value="<?php echo $t['trainer_id']; ?>" <?php echo ($t['trainer_id'] == $data['trainer_id']) ? 'selected' : ''; ?>><?php echo $t['first_name'] . ' ' . $t['last_name']; ?></option>
            <?php endforeach; ?>
        </select>
    </div>
    <div class="mb-3">
        <label for="scheduled_date" class="form-label">Scheduled Date</label>
        <input type="date" class="form-control" id="scheduled_date" name="scheduled_date" value="<?php echo $data['scheduled_date']; ?>" required>
    </div>
    <div class="mb-3">
        <label for="scheduled_time" class="form-label">Scheduled Time</label>
        <input type="time" class="form-control" id="scheduled_time" name="scheduled_time" value="<?php echo $data['scheduled_time']; ?>" required>
    </div>
    <div class="mb-3">
