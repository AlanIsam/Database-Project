...
<form method="post">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="program_duration" name="program_duration" placeholder="e.g., 12 Weeks">
    </div>
    <div class="mb-3">
        <label for="program_fee" class="form-label">Fee</label>
        <input type="number" step="0.01" class="form-control" id="program_fee" name="program_fee">
    </div>
